...
void Level1 (int* LevelNumber, ManType* Man, AllImageType AllImage, CamType* Camera)
    ...
    BlockType ManyBlocks [] = {
                            ...
                            {{0, 0}, 10, {0, 0, &AllImage.Grass}, BT_Dirt, AirInteraction},
                            {{0, 0}, 10, {0, 0, &AllImage.Grass}, BT_Dirt, AirInteraction},
                            {{0, 0}, 10, {0, 0, &AllImage.Grass}, BT_Dirt, AirInteraction},
                            {{0, 0}, 10, {0, 0, &AllImage.Grass}, BT_Dirt, AirInteraction},
                            {{0, 0}, 10, {0, 0, &AllImage.Grass}, BT_Dirt, AirInteraction},
                            ...
                            {{0, 0}, 10, {0, 0, &AllImage.Grass}, BT_Dirt, AirInteraction},
                            // End
                            {{-1, -1}, 1, {0, 0, &AllImage.Finish}, BT_Finish, AirInteraction}};
...
void TestLevel (int* LevelNumber, ManType* Man, AllImageType AllImage, CamType* Camera)
    ...
    BlockType ManyBlocks [] = {{{ -75,  675}, 6, {0, 0, &AllImage.Dirt}, BT_Dirt, AirInteraction},
                               {{-1, -1000000}, 1, {0, 0, &AllImage.Finish}, BT_Finish, AirInteraction}};
